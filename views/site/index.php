                            ...
                            <div class="carousel-prop">
                                    ...
                                    <div class="properties-thumb">
                                        ...
                                        <div class="user-preview">
                                            <a class="col" href="agent.html">
                                                <!-- <img alt="Camilė" class="avatar avatar-small" src="@web/img/4.png" title="Camilė"> -->
                                                <?= Html::img('@web/img/4.png', ['class'=>'avatar avatar-small']);?>        
                                            </a> 
                                        </div>
                                ...
                                <div class="properties-box">
                                    <div class="properties-thumb">
                                        ...
                                        <?= Html::img('@web/img/demo/property2.jpg');?>
                                        <span class="spn-status"> For Rent </span>
                                        <span class="spn-save"> <i class="ti ti-heart"></i> </span>
                                        <ul class="property-info">
                                            <li> 
                                        ...
                                        <div class="user-preview">
                                            <a class="col" href="agent.html">
                                            <?= Html::img('@web/img/3.png', ['class'=>'avatar avatar-small']);?>                                               </a> 
                                        </div>     
                                        <a class="proeprty-sh-more" href="property.html"><i class="ti ti-share"> </i></a>
                                ...
                                <div class="properties-box">
                                    <div class="properties-thumb">
                                        ...
                                        <?= Html::img('@web/img/demo/property3.jpg');?>
                                        ...
                                        <div class="user-preview">
                                            <a class="col" href="agent.html">
                                                 <?= Html::img('@web/img/1.png', ['class'=>'avatar avatar-small']);?>  
                                            </a> 
                                        </div> 
                                        <a class="proeprty-sh-more" href="property.html"><i class="ti ti-share"> </i></a>
                                ...
                                <div class="properties-box">
                                    <div class="properties-thumb">
                                        ...
                                        <?= Html::img('@web/img/demo/property4.jpg');?>
                                        ...
                                        <div class="user-preview">
                                            <a class="col" href="agent.html">
                                                <?= Html::img('@web/img/2.png', ['class'=>'avatar avatar-small']);?>
                                            </a> 
                                        </div> 
                                        <a class="proeprty-sh-more" href="property.html"><i class="ti ti-share"> </i></a>
                                ...
                                <div class="properties-box">
                                    <div class="properties-thumb">
                                        <?= Html::img('@web/img/demo/property5.jpg');?>
                                ...
                                <div class="col-md-4">
                                    <div class="properties-box">
                                        <div class="properties-thumb">
                                            ...
                                            <div class="user-preview">
                                                <a class="col" href="agent.html">
                                                   <?= Html::img('@web/img/3.png', ['class'=>'avatar avatar-small']);?>  
                                                </a> 
                                            </div> 
                                            <a class="proeprty-sh-more" href="property.html"><i class="ti ti-share"> </i></a>
                        ...
                        <div class="agents-carousal-sec">
                            ...
                            <div class="our-clients-sec">
                                <ul class="carousel-client">
                                    <li>
                                        <a href="#" title="">
                                            <!-- <img src="img/clients/our-client1.jpg" alt="" /> -->
                                            <?= Html::img('@web/img/clients/our-client1.jpg');?>

                                        </a>
                                    </li>
                                    <li>
                                        <a href="#" title="">
                                            <?= Html::img('@web/img/clients/our-client2.jpg');?>
                                            <!-- <img src="img/clients/our-client2.jpg" alt="" /></a> -->
                                    </li>
                                    <li>
                                        <a href="#" title="">
                                            <?= Html::img('@web/img/clients/our-client3.jpg');?>
                                            <!-- <img src="img/clients/our-client3.jpg" alt="" /> -->
                                        </a>
                                    </li>
                                    <li>
                                        <a href="#" title="">
                                                <?= Html::img('@web/img/clients/our-client4.jpg');?>
                                                <!-- <img src="img/clients/our-client4.jpg" alt="" /> -->
                                        </a>
                                    </li>
                                    <li>
                                        <a href="#" title="">
                                            <?= Html::img('@web/img/clients/our-client5.jpg');?>    
                                            <!-- <img src="img/clients/our-client5.jpg" alt="" /> -->
                                        </a>
                                    </li>
                                    <li>
